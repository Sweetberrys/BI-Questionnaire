...
<!--            <el-input placeholder="请输入账号查询" style="margin-left:60%;width: 200px" v-model="username" ></el-input>-->
            <el-input
                placeholder="请输入账号查询"
                style="margin-left: 60%; width: 200px"
                v-model="username"
                @keyup.enter="load(1)"
            ></el-input>
        ...
        <el-dialog title="管理员" :rules="rules" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false"
                   destroy-on-close>
