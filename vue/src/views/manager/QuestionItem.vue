...
<template>
    <div>
        <div class="search">
            ...
            <el-input placeholder="请输入题目内容查询" style="margin-left:40%;width: 200px;margin-right: 10px"
                      v-model="content"></el-input>
            <el-input placeholder="请输入题目名称查询" style="width: 200px;margin-right: 10px"
        ...
        <div class="table">
            <el-table :data="tableData" strip @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="questionName" label="所属题目"></el-table-column>
                <el-table-column prop="userName" label="创建人"></el-table-column>
                <el-table-column prop="createTime" label="题目内容创建时间"></el-table-column>
    ...
    methods: {
        ...
        save() {   // 保存按钮触发的逻辑  它会触发新增或者更新
            this.$refs.formRef.validate((valid) => {
                if (valid) {
                    this.$request.get('/question/selectById/' + this.form.questionId).then(res => {
                        console.log(res)
                        if (res.data === null) {
